...
const F1Data = {
  ...
  constructorDsc: () => loadJSON('constructor-dsc.json'),
  comebacks: () => loadJSON('comebacks.json'),
  circuitStats: () => loadJSON('circuit-stats.json'),
  poleToWin: () => loadJSON('pole-to-win.json'),
  seasonDrama: () => loadJSON('season-drama.json'),
  engineStats: () => loadJSON('engine-stats.json'),
  dynasties: () => loadJSON('dynasties.json'),
  dnfReasons: () => loadJSON('dnf-reasons.json'),
  circuitPoleHistory: () => loadJSON('circuit-pole-history.json'),
